    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <fieldset>
                ...
                <asp:TextBox ID="Query" runat="server" CssClass="form-control" />
            </fieldset>
        ...
        <div class="col-md-4">
            ...
            <asp:GridView ID="LdapResults" runat="server" CssClass="table table-hover table-condensed"></asp:GridView>
        </div>
    </div>
    <script>
        $(function () {
